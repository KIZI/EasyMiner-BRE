/*
 * Source: http://labs.bigroomstudios.com/libraries/Apprise-v2
 * Edited: Přemysl Václav Duben 27/4/2014 - added opacity setting row 50 and 192
 */
...
function Apprise(text, options) {
	...
	$overlay.css('opacity', settings.opacity).fadeIn(300);
